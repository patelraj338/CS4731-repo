...
public class MyLevel extends Level{
	...
	private static final int SEGMENTLENGTH = 3;
	...
	public void create(MyDNA dna, int type)
	{
        ...
        for (int x = STARTOFFSET + 6; x < width - EXITOFFSET; x=x+3) {
            int num = x - STARTOFFSET;
            if (chrom.charAt(num/3) == 'p') {
                buildPowerUP(x);
            }
            else if (chrom.charAt(num/3) == 'c') {
                buildCoin(x);
            }
            else if (chrom.charAt(num/3) == 'j') {
                buildGap(x);
            }
            else if (chrom.charAt(num/3) == 'b') {
                buildBuffer(x);
            }
            else if (chrom.charAt(num/3) == 'e') {
                buildEnemy(x);
            }
...
//        this.setBlock(start+2, DEFAULTHEIGHT-8, ROCK);
        ...
        this.setBlock(start+2, DEFAULTHEIGHT-2, HILL_TOP);
        this.setBlock(start+2, DEFAULTHEIGHT - 1, GROUND);
    }
...
//            this.setBlock(x, DEFAULTHEIGHT - 8, ROCK);
    ...
    public void buildCoin(int start) {
        for (int x = start; x < start + SEGMENTLENGTH; x++) {
            this.setBlock(x, DEFAULTHEIGHT-15, COIN);
            ...
            this.setBlock(x, DEFAULTHEIGHT-4, COIN);
            this.setBlock(x, DEFAULTHEIGHT-3, COIN);
            this.setBlock(x, DEFAULTHEIGHT-2, HILL_TOP);
            this.setBlock(x, DEFAULTHEIGHT - 1, GROUND);
        }
